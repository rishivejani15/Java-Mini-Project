 ...
 * @author Dhanesh
 */
public class FCN extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
