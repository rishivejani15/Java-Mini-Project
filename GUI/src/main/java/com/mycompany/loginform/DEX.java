 ...
 * @author Dhanesh
 */
public class DEX extends javax.swing.JFrame {

    /**
     * Creates new form DEX
     */
    public DEX() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DEX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
